 ...
 *
 * @generated from core/zgemm_batchf.c, normal z -> s, Sat Oct 27 15:01:39 2018
 *
 **/
 ...
 * @ingroup gemm_batchf
 *
 * sgemm_batchf is a batch version of sgemm. It performs 
 ...
 *
 ******************************************************************************/
void blas_sgemm_batchf(int group_size, bblas_enum_t layout, bblas_enum_t transa,
