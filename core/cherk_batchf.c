 ...
 *
 * @generated from core/zherk_batchf.c, normal z -> c, Sat Oct 27 15:01:39 2018
 *
 **/
...
void blas_cherk_batchf(int group_size, bblas_enum_t layout, bblas_enum_t uplo,
