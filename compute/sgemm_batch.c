 ...
 *
 * @generated from compute/zgemm_batch.c, normal z -> s, Sat Oct 27 15:01:38 2018
 *
 **/
 ...
 * @ingroup gemm_batch
 *
 * blas_sgemm_batch is a batch version of sgemm. It performs 
		      ...
		      int *info)
{
	...
	for (int group_iter = 0; group_iter < group_count; group_iter++) {
		...
		// Call to blas_sgemm_batchf 
		blas_sgemm_batchf(group_sizes[group_iter], 
