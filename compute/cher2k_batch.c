 ...
 *
 * @generated from compute/zher2k_batch.c, normal z -> c, Sat Oct 27 15:01:39 2018
 *
 **/
...

{
	...
	for (int group_iter = 0; group_iter < group_count; group_iter++) {
		...
		if (n[group_iter] == 0 ||
				((k[group_iter] == 0 || alpha[group_iter] == (bblas_complex32_t)0.0) 
		...
		// Call to blas_cher2k_batchf 
		blas_cher2k_batchf(group_sizes[group_iter], 
