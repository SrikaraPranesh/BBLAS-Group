 ...
 *
 * @generated from compute/zsymm_batch.c, normal z -> s, Sat Oct 27 15:01:39 2018
 *
 **/
 ...
 *          Specifies whether the symmetric matrices A[j]-s of i-th 
...

{
	...
	for (int group_iter = 0; group_iter < group_count; group_iter++) {
		...
		// Call to blas_ssymm_batchf 
		blas_ssymm_batchf(group_sizes[group_iter], 
